 ...
 *
 *  params:
 *    -i /home/giulio/sv-benchmarks-svcomp21/c//pthread/bigshot_p.c, --unwind 3, --rounds 3, --seq , --debug , 
 *
 */
...
static __CPROVER_bitvector[1] _a__cseq_distinguished_global_nondet_4;
static __CPROVER_bitvector[1] _a__cseq_distinguished_global_nondet_5 = nonDeterministicNumber();
static __CPROVER_bitvector[1] _a__cseq_distinguished_global_nondet_6 = nonDeterministicNumber();
static __CPROVER_bitvector[1] _a__cseq_distinguished_global_nondet_7 = nonDeterministicNumber();
...
int __cs_mutex_lock(__cs_mutex_t *__cs_mutex_to_lock, unsigned __CPROVER_bitvector[2] __cs_thread_index)
{
    ...
    __CPROVER_assume((*__cs_mutex_to_lock) == (-1) && _a__cseq_distinguished_global_nondet_1);
...
void *thread2_0(void *__cs_param_thread2_arg)
{
    ...
    ;
    ;
    static _Bool local_thread2___cs_tmp_if_cond_1;
    tthread2_0_1:
    IF(1,1,tthread2_0_2)
    local_thread2___cs_tmp_if_cond_1 = v;
    if (local_thread2___cs_tmp_if_cond_1)
    {
        tthread2_0_2:
        IF(1,2,tthread2_0_3)
        strcpy(v, "Bigshot");
...
int main_thread(void)
{
    ...
    static __cs_t local_main_t1;
    ;
    ;
    static __cs_t local_main_t2;
    ;
    ;
    __cs_create(&local_main_t1, 0, thread1_0, 0, 0);
    tmain_thread_1:
    IF(2,1,tmain_thread_2)
    __cs_create(&local_main_t2, 0, thread2_0, 0, 1);
    tmain_thread_2:
    IF(2,2,tmain_thread_3)
    __cs_join(local_main_t1, 0);
    tmain_thread_3:
    IF(2,3,tmain_thread_4)
    __cs_join(local_main_t2, 0);
    tmain_thread_4:

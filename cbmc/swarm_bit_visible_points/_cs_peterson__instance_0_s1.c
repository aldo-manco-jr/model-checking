 ...
 * 
 *  instance version    {"thr1_0": [[1, 1]], "thr2_0": [[2, 2]], "main": [[1, 1]]}
 *
 *  2022-07-07 12:38:48
 *
 *  params:
 *    --vs , -i peterson.c, --sat-swarm , --instances-only , 
 *
 */
...
#define SMSIZE 5
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {2, 2, 4};
                                        ...
                                        *__cs_cond_to_broadcast = 1;
                                        ...
                                        {
IF(0,_cs_SwCtrl_0_0,tthr1_0_1)
                                        flag1 = 1;
tthr1_0_1:
IF(0,_cs_SwCtrl_0_1,tthr1_0_2)
                                        turn = 1;
...
tthr1_0_2: 
                                        ...
                                        {
IF(1,_cs_SwCtrl_1_0,tthr2_0_1)
                                        flag2 = 1;
                                        turn = 0;
tthr2_0_1:
IF(1,_cs_SwCtrl_1_1,tthr2_0_2)
...
tthr2_0_2: 
                                        ...
                                        {
IF(2,_cs_SwCtrl_2_0,tmain_thread_1)
                                        ...
                                        ;
                                                ;
                                        __cs_create(&__cs_local_main_t1, 0, thr1_0, 0, 0);
tmain_thread_1:
IF(2,_cs_SwCtrl_2_1,tmain_thread_2)
                                        __cs_create(&__cs_local_main_t2, 0, thr2_0, 0, 1);
tmain_thread_2:
IF(2,_cs_SwCtrl_2_2,tmain_thread_3)
                                        __cs_join(__cs_local_main_t1, 0);
tmain_thread_3:
IF(2,_cs_SwCtrl_2_3,tmain_thread_4)
